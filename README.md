...
# Check for data quality (negative quantity, negative revenue, or revenue values that do not match quantity * unit_price within an absolute tolerance amount. Default tolerance value is 0.01)
